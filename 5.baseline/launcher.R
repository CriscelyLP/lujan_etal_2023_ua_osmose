...
setwd("/run/media/criscelylujan/Disk1/RUN/sensitivity_osmose/sensitivity_osmose/uncertaintyAnalysis_postProcessing")
source("indicators.R")
...
library("osmose")
setwd("/run/media/criscelylujan/Disk1/RUN/run_uncertainty_osmose-datarmor/run_osmose_baseLine")
