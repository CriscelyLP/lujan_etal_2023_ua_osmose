...
figure2_rc = function(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
  ...
  distance = (18:1) + 0.17*c(-1,1)
  
  boxplot(toPlot_sim10p_sp0*100, at = distance[1] , outline = FALSE, axes = FALSE, ylim = lim, col = "white", xlim = c(0.5,18.5), horizontal = TRUE)
  boxplot(toPlot_sim20p_sp0*100, at = distance[2] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp1*100, at = distance[3] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp1*100, at = distance[4] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp2*100, at = distance[5] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp2*100, at = distance[6] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp3*100, at = distance[7] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp3*100, at = distance[8] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp4*100, at = distance[9] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp4*100, at = distance[10], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp5*100, at = distance[11], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp5*100, at = distance[12], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp6*100, at = distance[13], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp6*100, at = distance[14], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp7*100, at = distance[15], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp7*100, at = distance[16], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
  boxplot(toPlot_sim10p_sp8*100, at = distance[17], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE)
  boxplot(toPlot_sim20p_sp8*100, at = distance[18], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE)
...
png(filename = "indicators/plots/figures_chapter/2.figure2A.png", width = 1200, height = 900, pointsize = 16)
par(mfrow = c(3, 3))
par(cex   = 1)
...
figure2_rc(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           ...
           lim = c(-25, 25), col = coloursBox[1], lwd = 2, speciesName = speciesComplete)
...
figure2_rc(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           ...
           lim = c(-250, 250), col = coloursBox[1], lwd = 2, speciesName = speciesComplete)

figure2_rc(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           sim20p_sp0, sim20p_sp1, sim20p_sp2, sim20p_sp3, sim20p_sp4, sim20p_sp5, sim20p_sp6, sim20p_sp7, sim20p_sp8,
           ind = "relativeChange", var = "mti", titlePlot = "UNCERTAINTY ON MARINE TROPHIC INDEX" ,
           lim = c(-3.5, 3.5), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
...
figure2_rc(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           ...
           lim = c(-130, 130), col = coloursBox[1], lwd = 2, speciesName = speciesComplete)

figure2_rc(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           sim20p_sp0, sim20p_sp1, sim20p_sp2, sim20p_sp3, sim20p_sp4, sim20p_sp5, sim20p_sp6, sim20p_sp7, sim20p_sp8,
           ind = "relativeChange", var = "lfi30", titlePlot = "UNCERTAINTY ON LFI30" ,
           lim = c(-200, 200), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
...
legend("bottomright", legend = c("SCENARIO 10%", "SCENARIO 20%"), bty = "n",
       fill = c("white", "azure4"), border = "black", cex = 1, xpd = TRUE)
...
figure2_cv = function(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
  ...
  segments(0, distance[3 ], toPlot_sim10p_sp1, distance[3 ], col = "black", lty = 2)
  segments(0, distance[4 ], toPlot_sim20p_sp1, distance[4 ], col = "black", lty = 2)
  segments(0, distance[5 ], toPlot_sim10p_sp2, distance[5 ], col = "black", lty = 2)
  segments(0, distance[6 ], toPlot_sim20p_sp2, distance[6 ], col = "black", lty = 2)
  segments(0, distance[7 ], toPlot_sim10p_sp3, distance[7 ], col = "black", lty = 2)
  segments(0, distance[8 ], toPlot_sim20p_sp3, distance[8 ], col = "black", lty = 2)
  segments(0, distance[9 ], toPlot_sim10p_sp4, distance[9 ], col = "black", lty = 2)
  segments(0, distance[10], toPlot_sim20p_sp4, distance[10], col = "black", lty = 2)
  segments(0, distance[11], toPlot_sim10p_sp5, distance[11], col = "black", lty = 2)
  segments(0, distance[12], toPlot_sim20p_sp5, distance[12], col = "black", lty = 2)
  segments(0, distance[13], toPlot_sim10p_sp6, distance[13], col = "black", lty = 2)
  segments(0, distance[14], toPlot_sim20p_sp6, distance[14], col = "black", lty = 2)
  segments(0, distance[15], toPlot_sim10p_sp7, distance[15], col = "black", lty = 2)
  segments(0, distance[16], toPlot_sim20p_sp7, distance[16], col = "black", lty = 2)
  segments(0, distance[17], toPlot_sim10p_sp8, distance[17], col = "black", lty = 2)
  segments(0, distance[18], toPlot_sim20p_sp8, distance[18], col = "black", lty = 2)
  
  points(x = toPlot_sim10p_sp0, y = distance[1 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp0, y = distance[2 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp1, y = distance[3 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp1, y = distance[4 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp2, y = distance[5 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp2, y = distance[6 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp3, y = distance[7 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp3, y = distance[8 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp4, y = distance[9 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp4, y = distance[10], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp5, y = distance[11], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp5, y = distance[12], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp6, y = distance[13], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp6, y = distance[14], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp7, y = distance[15], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp7, y = distance[16], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = toPlot_sim10p_sp8, y = distance[17], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = toPlot_sim20p_sp8, y = distance[18], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
...
png(filename = "indicators/plots/figures_chapter/2.figure2B_new2.png", width = 1200, height = 900, pointsize = 16)
par(mfrow = c(3, 3))
par(cex   = 1)
par(mar   = c(2.5,2.5,1,0), oma = c(3,4,1,0.5))
...
figure2_cv(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           ...
           xlim = c(0, 3)        , col = coloursBox[1], lwd = 2, speciesName = speciesComplete)
...
figure2_cv(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           ...
           xlim = c(0, 11)        , col = coloursBox[1], lwd = 2, speciesName = speciesComplete)

figure2_cv(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           sim20p_sp0, sim20p_sp1, sim20p_sp2, sim20p_sp3, sim20p_sp4, sim20p_sp5, sim20p_sp6, sim20p_sp7, sim20p_sp8,
           ind = "coefficientVariation", var = "meanLifespan", titlePlot = "UNCERTAINTY ON MEAN LIFESPAN" ,
           xlim = c(0, 11)        , col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)

figure2_cv(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
           sim20p_sp0, sim20p_sp1, sim20p_sp2, sim20p_sp3, sim20p_sp4, sim20p_sp5, sim20p_sp6, sim20p_sp7, sim20p_sp8,
           ind = "coefficientVariation", var = "biomassOverYield", titlePlot = "UNCERTAINTY ON BIOMASS OVER YIELD" ,
           xlim = c(0, 80)           , col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
