...
png(filename = "indicators/plots/figures_chapter/figure4A_10p.png", width = 1200, height = 900, pointsize = 16)
par(mfrow = c(3, 3))
par(cex   = 1)
...
figure4A_rc(sim1_sp0 = biomass_rc_sp0_10p_before, sim1_sp1 = biomass_rc_sp1_10p_before, sim1_sp2 = biomass_rc_sp2_10p_before, sim1_sp3 = biomass_rc_sp3_10p_before, sim1_sp4 = biomass_rc_sp4_10p_before, sim1_sp5 = biomass_rc_sp5_10p_before, sim1_sp6 = biomass_rc_sp6_10p_before, sim1_sp7 = biomass_rc_sp7_10p_before, sim1_sp8 = biomass_rc_sp8_10p_before,
            sim2_sp0 = biomass_rc_sp0_10p_after , sim2_sp1 = biomass_rc_sp1_10p_after , sim2_sp2 = biomass_rc_sp2_10p_after , sim2_sp3 = biomass_rc_sp3_10p_after , sim2_sp4 = biomass_rc_sp4_10p_after , sim2_sp5 = biomass_rc_sp5_10p_after , sim2_sp6 = biomass_rc_sp6_10p_after , sim2_sp7 = biomass_rc_sp7_10p_after , sim2_sp8 = biomass_rc_sp8_10p_after ,
            sp = 2, titlePlot = "UNCERTAINTY ON HAKE"          , lim = c(-250,250), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)

figure4A_rc(sim1_sp0 = biomass_rc_sp0_10p_before, sim1_sp1 = biomass_rc_sp1_10p_before, sim1_sp2 = biomass_rc_sp2_10p_before, sim1_sp3 = biomass_rc_sp3_10p_before, sim1_sp4 = biomass_rc_sp4_10p_before, sim1_sp5 = biomass_rc_sp5_10p_before, sim1_sp6 = biomass_rc_sp6_10p_before, sim1_sp7 = biomass_rc_sp7_10p_before, sim1_sp8 = biomass_rc_sp8_10p_before,
            sim2_sp0 = biomass_rc_sp0_10p_after , sim2_sp1 = biomass_rc_sp1_10p_after , sim2_sp2 = biomass_rc_sp2_10p_after , sim2_sp3 = biomass_rc_sp3_10p_after , sim2_sp4 = biomass_rc_sp4_10p_after , sim2_sp5 = biomass_rc_sp5_10p_after , sim2_sp6 = biomass_rc_sp6_10p_after , sim2_sp7 = biomass_rc_sp7_10p_after , sim2_sp8 = biomass_rc_sp8_10p_after ,
            sp = 3, titlePlot = "UNCERTAINTY ON SARDINE"       , lim = c(-500,500), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
...
mtext(text = "NIÑO EFFECT IN THE RELATIVE CHANGE OF BIOMASS - SCENARIO 10%" , side = 1, cex = 1.5  , line = 1.2, adj = 0.5, outer = TRUE)
...
png(filename = "indicators/plots/figures_chapter/4.figure4A_20p_new.png", width = 1200, height = 1800, pointsize = 24)
par(mfrow = c(5, 2))
par(cex   = 1)
par(mar   = c(2.5,2.5,1,0), oma = c(4,4,1,0.5))
...
figure4A_rc(sim1_sp0 = biomass_rc_sp0_20p_before, sim1_sp1 = biomass_rc_sp1_20p_before, sim1_sp2 = biomass_rc_sp2_20p_before, sim1_sp3 = biomass_rc_sp3_20p_before, sim1_sp4 = biomass_rc_sp4_20p_before, sim1_sp5 = biomass_rc_sp5_20p_before, sim1_sp6 = biomass_rc_sp6_20p_before, sim1_sp7 = biomass_rc_sp7_20p_before, sim1_sp8 = biomass_rc_sp8_20p_before,
            sim2_sp0 = biomass_rc_sp0_20p_after , sim2_sp1 = biomass_rc_sp1_20p_after , sim2_sp2 = biomass_rc_sp2_20p_after , sim2_sp3 = biomass_rc_sp3_20p_after , sim2_sp4 = biomass_rc_sp4_20p_after , sim2_sp5 = biomass_rc_sp5_20p_after , sim2_sp6 = biomass_rc_sp6_20p_after , sim2_sp7 = biomass_rc_sp7_20p_after , sim2_sp8 = biomass_rc_sp8_20p_after ,
            sp = 3, titlePlot = "UNCERTAINTY ON SARDINE"       , lim = c(-500,500), col = coloursBox[1], lwd = 2, speciesName = speciesComplete)

figure4A_rc(sim1_sp0 = biomass_rc_sp0_20p_before, sim1_sp1 = biomass_rc_sp1_20p_before, sim1_sp2 = biomass_rc_sp2_20p_before, sim1_sp3 = biomass_rc_sp3_20p_before, sim1_sp4 = biomass_rc_sp4_20p_before, sim1_sp5 = biomass_rc_sp5_20p_before, sim1_sp6 = biomass_rc_sp6_20p_before, sim1_sp7 = biomass_rc_sp7_20p_before, sim1_sp8 = biomass_rc_sp8_20p_before,
            sim2_sp0 = biomass_rc_sp0_20p_after , sim2_sp1 = biomass_rc_sp1_20p_after , sim2_sp2 = biomass_rc_sp2_20p_after , sim2_sp3 = biomass_rc_sp3_20p_after , sim2_sp4 = biomass_rc_sp4_20p_after , sim2_sp5 = biomass_rc_sp5_20p_after , sim2_sp6 = biomass_rc_sp6_20p_after , sim2_sp7 = biomass_rc_sp7_20p_after , sim2_sp8 = biomass_rc_sp8_20p_after ,
            sp = 4, titlePlot = "UNCERTAINTY ON JACK MACKEREL" , lim = c(-250,250), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)

figure4A_rc(sim1_sp0 = biomass_rc_sp0_20p_before, sim1_sp1 = biomass_rc_sp1_20p_before, sim1_sp2 = biomass_rc_sp2_20p_before, sim1_sp3 = biomass_rc_sp3_20p_before, sim1_sp4 = biomass_rc_sp4_20p_before, sim1_sp5 = biomass_rc_sp5_20p_before, sim1_sp6 = biomass_rc_sp6_20p_before, sim1_sp7 = biomass_rc_sp7_20p_before, sim1_sp8 = biomass_rc_sp8_20p_before,
            sim2_sp0 = biomass_rc_sp0_20p_after , sim2_sp1 = biomass_rc_sp1_20p_after , sim2_sp2 = biomass_rc_sp2_20p_after , sim2_sp3 = biomass_rc_sp3_20p_after , sim2_sp4 = biomass_rc_sp4_20p_after , sim2_sp5 = biomass_rc_sp5_20p_after , sim2_sp6 = biomass_rc_sp6_20p_after , sim2_sp7 = biomass_rc_sp7_20p_after , sim2_sp8 = biomass_rc_sp8_20p_after ,
            sp = 5, titlePlot = "UNCERTAINTY ON CHUB MACKEREL" , lim = c(-250,250), col = coloursBox[1], lwd = 2, speciesName = speciesComplete)
...
figure4A_rc(sim1_sp0 = biomass_rc_sp0_20p_before, sim1_sp1 = biomass_rc_sp1_20p_before, sim1_sp2 = biomass_rc_sp2_20p_before, sim1_sp3 = biomass_rc_sp3_20p_before, sim1_sp4 = biomass_rc_sp4_20p_before, sim1_sp5 = biomass_rc_sp5_20p_before, sim1_sp6 = biomass_rc_sp6_20p_before, sim1_sp7 = biomass_rc_sp7_20p_before, sim1_sp8 = biomass_rc_sp8_20p_before,
            sim2_sp0 = biomass_rc_sp0_20p_after , sim2_sp1 = biomass_rc_sp1_20p_after , sim2_sp2 = biomass_rc_sp2_20p_after , sim2_sp3 = biomass_rc_sp3_20p_after , sim2_sp4 = biomass_rc_sp4_20p_after , sim2_sp5 = biomass_rc_sp5_20p_after , sim2_sp6 = biomass_rc_sp6_20p_after , sim2_sp7 = biomass_rc_sp7_20p_after , sim2_sp8 = biomass_rc_sp8_20p_after ,
            sp = 8, titlePlot = "UNCERTAINTY ON HUMBOLDT SQUID", lim = c(-700,700), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)

figure4A_rc(sim1_sp0 = biomass_rc_sp0_20p_before, sim1_sp1 = biomass_rc_sp1_20p_before, sim1_sp2 = biomass_rc_sp2_20p_before, sim1_sp3 = biomass_rc_sp3_20p_before, sim1_sp4 = biomass_rc_sp4_20p_before, sim1_sp5 = biomass_rc_sp5_20p_before, sim1_sp6 = biomass_rc_sp6_20p_before, sim1_sp7 = biomass_rc_sp7_20p_before, sim1_sp8 = biomass_rc_sp8_20p_before,
            sim2_sp0 = biomass_rc_sp0_20p_after , sim2_sp1 = biomass_rc_sp1_20p_after , sim2_sp2 = biomass_rc_sp2_20p_after , sim2_sp3 = biomass_rc_sp3_20p_after , sim2_sp4 = biomass_rc_sp4_20p_after , sim2_sp5 = biomass_rc_sp5_20p_after , sim2_sp6 = biomass_rc_sp6_20p_after , sim2_sp7 = biomass_rc_sp7_20p_after , sim2_sp8 = biomass_rc_sp8_20p_after ,
            sp = 9, titlePlot = "UNCERTAINTY ON EUPHAUSIIDS"   , lim = c(-70,70),   col = coloursBox[1], lwd = 2, speciesName = speciesComplete)

mtext(text = "RELATIVE CHANGE OF BIOMASS" ,
...
png(filename = "indicators/plots/figures_chapter/figure4B_10p.png", width = 1200, height = 900, pointsize = 16)
par(mfrow = c(3, 3))
par(cex   = 1)
par(mar   = c(2.5,2.5,1,0), oma = c(3,4,1,0.5))
...
figure4B_rc(sim_sp0 = sim10p_sp0, sim_sp1 = sim10p_sp1, sim_sp2 = sim10p_sp2, sim_sp3 = sim10p_sp3,
            ...
            lim = c(-4, 4), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
...
mtext(text = "NIÑO EFFECT IN THE RELATIVE CHANGE - SCENARIO 10%" , side = 1, cex = 1.5  , line = 1.2, adj = 0.5, outer = TRUE)

dev.off()

# 20P ---------------------------------------------------------------------

png(filename = "indicators/plots/figures_chapter/figure4B_20p_new2.png", width = 1200, height = 1400, pointsize = 24)
par(mfrow = c(3, 2))
par(cex   = 1)
...
figure4B_rc(sim_sp0 = sim20p_sp0, sim_sp1 = sim20p_sp1, sim_sp2 = sim20p_sp2, sim_sp3 = sim20p_sp3,
            sim_sp4 = sim20p_sp4, sim_sp5 = sim20p_sp5, sim_sp6 = sim20p_sp6, sim_sp7 = sim20p_sp7, sim_sp8 = sim20p_sp8,
            ind = "relativeChange", var = "lfi40", titlePlot = "UNCERTAINTY ON LFI40" ,
            lim = c(-320, 320), col = coloursBox[1], lwd = 2, speciesName = speciesAbbre)
