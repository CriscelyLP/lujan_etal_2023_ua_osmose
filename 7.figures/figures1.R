...
figure1_rc = function(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
  ...
  boxplot(sim20p_sp0[,sp]*100, at = distance[2] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp1[,sp]*100, at = distance[3] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp1[,sp]*100, at = distance[4] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp2[,sp]*100, at = distance[5] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp2[,sp]*100, at = distance[6] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp3[,sp]*100, at = distance[7] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp3[,sp]*100, at = distance[8] , outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp4[,sp]*100, at = distance[9] , outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp4[,sp]*100, at = distance[10], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp5[,sp]*100, at = distance[11], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp5[,sp]*100, at = distance[12], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp6[,sp]*100, at = distance[13], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp6[,sp]*100, at = distance[14], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp7[,sp]*100, at = distance[15], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp7[,sp]*100, at = distance[16], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
  boxplot(sim10p_sp8[,sp]*100, at = distance[17], outline = FALSE, axes = FALSE, add = TRUE, col = "white", horizontal = TRUE , width = 1.5)
  boxplot(sim20p_sp8[,sp]*100, at = distance[18], outline = FALSE, axes = FALSE, add = TRUE, col = "azure4", horizontal = TRUE, width = 1.5)
...
png(filename = "indicators/plots/figures_chapter/1.figure1A_new.png", width = 1200, height = 1800, pointsize = 24)
par(mfrow = c(5, 2))
par(cex   = 1)
...
figure1_cv = function(sim10p_sp0, sim10p_sp1, sim10p_sp2, sim10p_sp3, sim10p_sp4, sim10p_sp5, sim10p_sp6, sim10p_sp7, sim10p_sp8,
  ...
  segments(0, distance[3 ], sim10p_sp1[sp], distance[3 ], col = "black", lty = 2)
  segments(0, distance[4 ], sim20p_sp1[sp], distance[4 ], col = "black", lty = 2)
  segments(0, distance[5 ], sim10p_sp2[sp], distance[5 ], col = "black", lty = 2)
  segments(0, distance[6 ], sim20p_sp2[sp], distance[6 ], col = "black", lty = 2)
  segments(0, distance[7 ], sim10p_sp3[sp], distance[7 ], col = "black", lty = 2)
  segments(0, distance[8 ], sim20p_sp3[sp], distance[8 ], col = "black", lty = 2)
  segments(0, distance[9 ], sim10p_sp4[sp], distance[9 ], col = "black", lty = 2)
  segments(0, distance[10], sim20p_sp4[sp], distance[10], col = "black", lty = 2)
  segments(0, distance[11], sim10p_sp5[sp], distance[11], col = "black", lty = 2)
  segments(0, distance[12], sim20p_sp5[sp], distance[12], col = "black", lty = 2)
  segments(0, distance[13], sim10p_sp6[sp], distance[13], col = "black", lty = 2)
  segments(0, distance[14], sim20p_sp6[sp], distance[14], col = "black", lty = 2)
  segments(0, distance[15], sim10p_sp7[sp], distance[15], col = "black", lty = 2)
  segments(0, distance[16], sim20p_sp7[sp], distance[16], col = "black", lty = 2)
  segments(0, distance[17], sim10p_sp8[sp], distance[17], col = "black", lty = 2)
  segments(0, distance[18], sim20p_sp8[sp], distance[18], col = "black", lty = 2)
  
  points(x = sim10p_sp0[sp], y = distance[1 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp0[sp], y = distance[2 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp1[sp], y = distance[3 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp1[sp], y = distance[4 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp2[sp], y = distance[5 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp2[sp], y = distance[6 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp3[sp], y = distance[7 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp3[sp], y = distance[8 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp4[sp], y = distance[9 ], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp4[sp], y = distance[10], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp5[sp], y = distance[11], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp5[sp], y = distance[12], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp6[sp], y = distance[13], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp6[sp], y = distance[14], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp7[sp], y = distance[15], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp7[sp], y = distance[16], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
  points(x = sim10p_sp8[sp], y = distance[17], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "white", col = "black")
  points(x = sim20p_sp8[sp], y = distance[18], type = "p", pch = 21, lwd = 0.9, cex = cex.point, bg = "azure4", col = "black")
