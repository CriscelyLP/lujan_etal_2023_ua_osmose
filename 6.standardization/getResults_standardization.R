...
# BaseLine indicators -----------------------------------------------------
baseLine_meanLength            = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_meanLength.rds")
baseLine_meanTL                = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_meanTL.rds")
baseLine_meanLifespan          = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_meanLifespan.rds")
baseLine_biomassOverYield      = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_biomassOverYield.rds")
baseLine_mti                   = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_mti.rds")
baseLine_slopeSizeSpectrum     = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_slopeSizeSpectrum.rds")
baseLine_interceptSizeSpectrum = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_interceptSizeSpectrum.rds")
baseLine_lfi20                 = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_lfi20.rds")
baseLine_lfi30                 = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_lfi30.rds")
baseLine_lfi40                 = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_lfi40.rds")
baseLine_biomass_sp            = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_biomass_sp.rds")
baseLine_abundance_sp          = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_abundance_sp.rds")
baseLine_yield_sp              = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_yield_sp.rds")
baseLine_meanTL_sp             = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_meanTL_sp.rds")
baseLine_meanLength_sp         = readRDS("run_osmose_baseLine/indicatorsMean_baseLine/baseLine_meanLength_sp.rds")
...
procesingIndicators = function(sp, scenario){
  ...
  # read indicators
  meanLength            = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "meanLength.rds", sep="_")))
  meanTL                = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "meanTL.rds", sep="_")))
  meanLifespan          = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "meanLifespan.rds", sep="_")))
  biomassOverYield      = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "biomassOverYield.rds", sep="_")))
  mti                   = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "mti.rds", sep="_")))
  slopeSizeSpectrum     = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "slopeSizeSpectrum.rds", sep="_")))
  interceptSizeSpectrum = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "interceptSizeSpectrum.rds", sep="_")))
  lfi20                 = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "lfi20.rds", sep="_")))
  lfi30                 = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "lfi30.rds", sep="_")))
  lfi40                 = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "lfi40.rds", sep="_")))
  biomass_sp            = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "biomass_sp.rds", sep="_")))
  abundance_sp          = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "abundance_sp.rds", sep="_")))
  yield_sp              = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "yield_sp.rds", sep="_")))
  meanTL_sp             = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "meanTL_sp.rds", sep="_")))
  meanLength_sp         = readRDS(file.path("indicators/1.indicators_datarmor-outputs", paste(sp, scenario, sep="_"), paste(scenario, sp, "meanLength_sp.rds", sep="_")))
...
#10P
saveRDS(object = sim10p_sp0, file = file.path("indicators/2.indicators_processed", "sim10p_sp0.rds"))
saveRDS(object = sim10p_sp1, file = file.path("indicators/2.indicators_processed", "sim10p_sp1.rds"))
saveRDS(object = sim10p_sp2, file = file.path("indicators/2.indicators_processed", "sim10p_sp2.rds"))
saveRDS(object = sim10p_sp3, file = file.path("indicators/2.indicators_processed", "sim10p_sp3.rds"))
saveRDS(object = sim10p_sp4, file = file.path("indicators/2.indicators_processed", "sim10p_sp4.rds"))
saveRDS(object = sim10p_sp5, file = file.path("indicators/2.indicators_processed", "sim10p_sp5.rds"))
saveRDS(object = sim10p_sp6, file = file.path("indicators/2.indicators_processed", "sim10p_sp6.rds"))
saveRDS(object = sim10p_sp7, file = file.path("indicators/2.indicators_processed", "sim10p_sp7.rds"))
saveRDS(object = sim10p_sp8, file = file.path("indicators/2.indicators_processed", "sim10p_sp8.rds"))

#20P
saveRDS(object = sim20p_sp0, file = file.path("indicators/2.indicators_processed", "sim20p_sp0.rds"))
saveRDS(object = sim20p_sp1, file = file.path("indicators/2.indicators_processed", "sim20p_sp1.rds"))
saveRDS(object = sim20p_sp2, file = file.path("indicators/2.indicators_processed", "sim20p_sp2.rds"))
saveRDS(object = sim20p_sp3, file = file.path("indicators/2.indicators_processed", "sim20p_sp3.rds"))
saveRDS(object = sim20p_sp4, file = file.path("indicators/2.indicators_processed", "sim20p_sp4.rds"))
saveRDS(object = sim20p_sp5, file = file.path("indicators/2.indicators_processed", "sim20p_sp5.rds"))
saveRDS(object = sim20p_sp6, file = file.path("indicators/2.indicators_processed", "sim20p_sp6.rds"))
saveRDS(object = sim20p_sp7, file = file.path("indicators/2.indicators_processed", "sim20p_sp7.rds"))
saveRDS(object = sim20p_sp8, file = file.path("indicators/2.indicators_processed", "sim20p_sp8.rds"))
