...
setwd("/home/datawork-marbec-scenlab/OSMOSE/Criscely/ua_osmose_paper/outputs_uncertainty/sp1_30p")

doe = readRDS(file = "doe_sp1_30p.rds")
...
start = date()
fixed30p_sp1 = run_experiments(X = doe, FUN = run_model, names=doe$parameter, parallel=TRUE)
end   = date()

saveRDS(object = fixed30p_sp1, file = "fixed30p_sp1.rds")
