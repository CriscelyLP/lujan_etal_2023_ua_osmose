...
setwd("/home/datawork-marbec-scenlab/OSMOSE/Criscely/ua_osmose_paper/outputs_uncertainty/sp4_30p")

doe = readRDS(file = "doe_sp4_30p.rds")
...
start = date()
fixed30p_sp4 = run_experiments(X = doe, FUN = run_model, names=doe$parameter, parallel=TRUE)
end   = date()

saveRDS(object = fixed30p_sp4, file = "fixed30p_sp4.rds")
