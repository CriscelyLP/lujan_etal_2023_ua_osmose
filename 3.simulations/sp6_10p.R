...
run_model = function(par, names, ...) {
  ...
  amax.sp6 = par[names(par) == "species.lifespan.sp6"]
  ...
  # maturity size
  sx.sp6   = par[names(par) == "species.smat.sp6"]
  smat.sp6 = ((sx.sp6)*(Linf.sp6.per - l0.sp6)) + l0.sp6
